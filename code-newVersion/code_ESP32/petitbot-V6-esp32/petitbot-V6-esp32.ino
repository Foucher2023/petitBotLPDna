...
// =================== Constantes =========================
static constexpr uint8_t LED_PIN = 8;          // Broche de la LED intégrée (NodeMCU)
// 2 pour esp8266
static constexpr uint8_t DNS_PORT = 53;       // Port DNS
static constexpr uint16_t EEPROM_SIZE = 256; // Taille de l'EEPROM
static constexpr const char* DEFAULT_SSID = "Petitbot N°test";
static constexpr uint8_t PIN_MOTOR1 = 0;          // Broche moteur // <-- UNIQUE POINT DE MODIFICATION DES BROCHES
static constexpr uint8_t PIN_MOTOR2 = 3;          // Broche moteur // <-- UNIQUE POINT DE MODIFICATION DES BROCHES
// 4 et 5 pour esp8266
...
void handleUpdateConfig() {
  if (server.hasArg("ssid")) {
    ...
    updateMotorPins(newPin1, newPin2); 
