...
//#include <ESP8266HTTPUpdateServer.h>  // Required for OTA   // ESP8266
//#include <EEPROM.h>                                         // ESP8266
...
struct DeviceConfig {
  ...
  unsigned int pinMotor1 = 0;    // D2
  unsigned int pinMotor2 = 2;    // D1
};
...
HTTPUpdateServer httpUpdater;  // OTA updater
